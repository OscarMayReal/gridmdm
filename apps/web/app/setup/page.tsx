...
export default function SetupPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-[100dvh] w-[100dvw] top-0 left-0 fixed bg-background">
            ...
            <p className="text-muted-foreground pb-5 max-w-[500px] text-center">Get started by acquiring Grid in your KeyStone tenant. Once acquired, go to the apps section of KeyStone and assign yourself to the Grid app. Then come back here and reload the page.</p>
            <Link href={process.env.NEXT_PUBLIC_KEYSTONE_ACQUIRE_URL!} target="_blank">
                <Button variant="outline"><SquareArrowOutUpRightIcon />Acquire Grid</Button>
            </Link>
        </div>
    )
}