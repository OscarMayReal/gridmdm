...
import { ListXIcon, PlusIcon, XIcon } from "lucide-react";
...
export function ProfilesTable() {
    const [profiles, setProfiles] = useState<{ data: any[], loaded: boolean }>({ data: [], loaded: false });
    ...
    const table = useReactTable({
        ...
        columns: [
            ...
            },
            {
                ...
                cell: ({ row }) => row.original.configurations?.length || 0,
            },
            {
                id: "users",
                header: "Users",
                cell: ({ row }) => row.original.userAssignments?.length || 0,
            },
            {
                id: "devices",
                header: "Devices",
        ...
        <>
            ...
            <div className="bg-white rounded-md border-1 border-[#e4e4e7] overflow-hidden">
                <GenericTable fallback={<Empty className="flex flex-col gap-2">
                    ...
                    <EmptyDescription>Profiles apply configurations to users or admin-enrolled devices.</EmptyDescription>
...
function CreateProfileDialog({ onCreate }: { onCreate: (profile: any) => void }) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Profiles apply one set of configurations to a user or admin-enrolled device.
                    </DialogDescription>
                </DialogHeader>
                <Separator />
                <Field>
