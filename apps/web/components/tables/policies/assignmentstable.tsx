...
import { Device, EnrolmentProfile, KeyStoneGroup, Policy, PolicyAssignment } from "@repo/database";
...
export function AssignmentsTable({ policy, setPolicy, refresh }: { policy: Policy, setPolicy: (policy: Policy) => void, refresh: () => void }) {
